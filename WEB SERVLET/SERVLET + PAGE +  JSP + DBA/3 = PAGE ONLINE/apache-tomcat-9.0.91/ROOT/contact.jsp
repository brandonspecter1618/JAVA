...
<html>
    <head>
          <title>Page PHP Revision</title>

    <meta charset="utf-8">
    <meta name="describes" content="HTML">
    ...
    <nav role="navigation" class="primary-navigation">
        <ul>
            ...
            <li><a href="php.html">PHP/JAVA</a>
                <ul>
                    <li><a href="./submenu/php1.html">PHP1</a></li>
                    <li><a href="#">PHP2</a></li>
                    <li><a href="#">PHP3</a></li>
                    <li><a href="#">PHP4</a></li>
                </ul>
    ...
    <form name="form" class="var_p" action="phpform.php">
        ...
        <button type="button" class="var_1button" onclick="jsTest()">Submit</button>

    </form>

    </div>

    <p class="var_p1" id="result"></p>
    ...
    <script src="../PHP/js/js1.js"></script>
